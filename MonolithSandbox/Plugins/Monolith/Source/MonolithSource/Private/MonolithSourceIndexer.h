...
private:
	...
	// Real Build.cs modules are indexed before loose plugin Source roots. This
	// path set prevents the loose coverage pass from parsing the same file twice.
	TSet<FString> IndexedSourcePaths;
